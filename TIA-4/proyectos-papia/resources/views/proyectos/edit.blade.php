...
<body>
    ...
    <form action="{{ route('proyectos.update', $proyecto) }}" method="POST">
        ...
        <textarea name="descripcion" required>{{ $proyecto->descripcion }}</textarea><br>

        <label for="metodologia">Metodología:</label>
        <input type="text" name="metodologia" value="{{ $proyecto->metodologia }}" required><br>

        <label for="docente">Docente:</label>
        <input type="text" name="docente" value="{{ $proyecto->docente }}" required><br>
