...
type nul > proyectos_pia\server\models\TipoProyecto.js
type nul > proyectos_pia\server\repositories\tipos_proyectos.js
type nul > proyectos_pia\server\routes\tipos_proyectos.js
